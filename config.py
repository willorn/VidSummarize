...
class ModelPaths:
    ...
    paraformer_path = Path() / 'utils' / 'models' / 'paraformer-offline-zh' / 'model.int8.onnx'
    tokens_path = Path() / 'utils' / 'models' / 'paraformer-offline-zh' / 'tokens.txt'
    punc_model_dir = Path() / 'utils' / 'models' / 'punc_ct-transformer_cn-en'
